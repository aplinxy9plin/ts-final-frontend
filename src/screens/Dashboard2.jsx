              ...
              vacancies.map((item) => 
                <div className="block12">
                  ...
                  <a
                    ...
                    href="#valid"
                    onClick={async (e) => {
                      const f = await fetch("http://178.205.101.202:81/get_vacancy/"+item.id)
                      const result = await f.json()
                      
                      const blocksFromHTML = convertFromHTML(
                        getText({
                          professional_area: result.professional_area,
                          specialization: result.specialization.description,
                          level: result.grade.description,
                          text: result.job_responsibilities.description,
                          special_advantages: result.special_advantages.description
                        })
                      )
