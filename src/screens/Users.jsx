...
const Dashboard = () => {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      const f = await fetch("http://178.205.101.202:81/analiz_all_candidates?UserToken=", requestOptions)
                    ...
                    <tbody>
                      <tr>
                        <td style={{
                          ...
                          <b>{item.candidates_firstname} {item.candidates_lastname}</b>
                        </td>
                        <td>
                          {item.score}
                        </td>
                        <td>
                          {item.specializations_title}
                        </td>
                      </tr>
                    </tbody>
                  </table>
